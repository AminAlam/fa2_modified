...
class TestApplyForcesPrecise:
    ...
    def test_apply_gravity_linear_exact(self):
        ...
        fa2util.apply_gravity([node], gravity=1.0, scalingRatio=1.0, useStrongGravity=False)
    ...
    def test_apply_gravity_strong_exact(self):
        ...
        fa2util.apply_gravity([node], gravity=1.0, scalingRatio=1.0, useStrongGravity=True)
