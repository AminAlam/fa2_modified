...
class TestLinAttraction:
    ...
    def test_attraction_distributed(self):
        ...
        fa2util.linAttraction(
            n1, n2, e=1.0, distributedAttraction=True, coefficient=1.0
        )
    ...
    def test_attraction_weighted_edge(self):
        ...
        fa2util.linAttraction(
            n1, n2, e=2.0, distributedAttraction=False, coefficient=1.0
        )
...
class TestApplyForces:
    ...
    def test_apply_gravity(self):
        ...
        fa2util.apply_gravity(
            nodes, gravity=1.0, scalingRatio=1.0, useStrongGravity=False
        )
    ...
    def test_apply_strong_gravity(self):
        ...
        fa2util.apply_gravity(
            nodes, gravity=1.0, scalingRatio=1.0, useStrongGravity=True
        )
